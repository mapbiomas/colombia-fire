...
import gcsfs
import ipywidgets as widgets  # Library to build interactive widgets in Jupyter notebooks
from IPython.display import display, HTML, clear_output  # Utilities to display content in Jupyter notebooks
from ipywidgets import VBox, HBox  # Containers to arrange widgets in vertical or horizontal boxes
