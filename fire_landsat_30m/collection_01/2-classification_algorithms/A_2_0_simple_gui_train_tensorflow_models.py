...
class TrainingInterface:
    ...
    def generate_checkboxes(self):
        ...
        for file in self.training_files:
            # Now extract version, region and year!
    ...
    def train_models_click(self, b):
        ...
        # Check that there are enough parts: trainings_v1_r01
        if len(check_parts) < 3:
            self.log(f"[ERROR] Unexpected checkbox label format: {clean_label}")
            return
        
        
        version = check_parts[1]  # e.g. v1 or v2
        region = check_parts[2]   # e.g. r01 or r04
    
        # Pattern: look for files containing this region
