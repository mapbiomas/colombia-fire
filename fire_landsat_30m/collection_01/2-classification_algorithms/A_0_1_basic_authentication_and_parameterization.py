# last_update: '2024/10/22', github:'mapbiomas/colombia-fire', source: 'IPAM', contact: 'contato@mapbiomas.org'
...
country = 'colombia'  # Set the country from the available options
...
algorithms = f'/content/colombia-fire/fire_landsat_30m/collection_01/2-classification_algorithms'

# TODO: training PDF viewer. Requires copying into this repository
# 'utils/google_collab_pdf_show.py' and the MapBiomas Fire network PDF.
# Meanwhile, the material is available at the Google Slides link.
# exec(open(f'/content/colombia-fire/utils/google_collab_pdf_show.py').read())
# pdf_path = '/content/colombia-fire/fire_landsat_30m/entrenamiento_de_monitoreo_de_cicatrices_de_fuego_en_regiones_de_la_red_mapBiomas.pdf'
